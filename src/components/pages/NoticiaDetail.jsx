...
export function NoticiaDetail (){
    ...
    // console.log(movieId)
    return(
        <Content className={styles.detailContainer + ' breakWidth2 marginCorrection'}>
            <h1 className='blue-title firstTitle'>Titulo Noticia</h1>
            ...
            <img src="https://inedla.mx/sitio-revision/img-web/DSC_1601.jpg" alt="" />
        </Content>
    )
}